...
var frequencySelect = document.getElementsByName("frequencyOfSchedule");
    ...
    $("select").on("change", function(){
     ...
     switch (option) {
       ...
       this.parentNode.nextSibling.firstChild.setAttribute("required", "true");
         break;
        case "Daily":
        console.log("Daily");
         break;
